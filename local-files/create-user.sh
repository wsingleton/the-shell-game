...
chmodSshDir="sudo chmod 700 /home/$newUsername/.ssh; sudo chmod 600 /home/$newUsername/.ssh/authorized_keys"
...
configureBashRc="sudo cp ~/preconfigured.bashrc /home/$newUsername/.bashrc && sudo chmod -w /home/$newUsername/.bashrc"
